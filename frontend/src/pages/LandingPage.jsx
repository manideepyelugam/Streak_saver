...
<div className="absolute  z-20 top-[-120px] left-[-300px] h-0 w-0 md:h-[700px] md:w-[700px] rounded-full 
bg-[#868686]  md:opacity-[0.30] blur-[422.8px]"></div>

<div className="absolute z-20 top-[-120px] right-[-300px] h-0 w-0 md:h-[700px] md:w-[700px] rounded-full 
bg-[#868686]  md:opacity-[0.30] blur-[422.8px]"></div>
